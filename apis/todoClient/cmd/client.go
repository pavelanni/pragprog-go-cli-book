...
var (
	// ErrConnection means connection error
	ErrConnection = errors.New("Connection error")
	// ErrNotFound means not found
	ErrNotFound = errors.New("Not found")
	// ErrInvalidResponse means invalid server response
	ErrInvalidResponse = errors.New("Invalid server response")
	// ErrInvalid means invalid data
	ErrInvalid = errors.New("Invalid data")
	// ErrNotNumber means it's not a number
